    ...
    public partial class InitialMigration : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ExhibitId = table.Column<Guid>(type: "TEXT", nullable: false),
                    ExhibitName = table.Column<string>(type: "TEXT", nullable: false),
                    ExhibitDescription = table.Column<string>(type: "TEXT", nullable: true),
                    PhotoUrl1 = table.Column<string>(type: "TEXT", nullable: false),
                    PhotoUrl2 = table.Column<string>(type: "TEXT", nullable: false)
                },
                constraints: table =>
                {
